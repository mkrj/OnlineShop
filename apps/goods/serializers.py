...
from goods.models import GoodsCategory, Goods, HotSearchWords, GoodsImage, Banner, GoodsCategoryBrand, IndexAd
...
class IndexCategorySerializer(serializers.ModelSerializer):
    ...
    def get_goods(self, obj):
        ...
        goods_serializer = GoodsSerializer(all_goods, many=True, context={'request': self.context['context']})
